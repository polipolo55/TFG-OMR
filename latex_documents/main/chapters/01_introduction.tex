...
scale---per-page effort estimates vary widely by source complexity, but they
consistently dominate the cost of corpus-level digitisation projects~\cite{calvoZaragozaUnderstandingOMR2020}.
\todo{ref?: a concrete per-page transcription-time figure (e.g.\ from a digital-libraries study) would strengthen this claim.}
...
time), 6/8, 6/4, 2/4, 5/4, and 12/8 all appear in the Real Book; these eight time
signatures constitute the in-scope set of this thesis (see \Cref{sec:scope}).

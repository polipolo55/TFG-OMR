...
back, or analysed without manual transcription into notation software. \todo{add reference }
...
at scale. \todo{add some kind of citation or estimate for the time it takes to transcribe a page of music by hand i completly made that up}
...
tools is correspondingly narrower as its a more specialized field.

\subsection{Jazz Lead Sheets and \textit{The Real Book}}


There are many formats of notated music, same as written language has many formats: novels, news articles, tweets, legal documents, and so on, apart from fonts and layout or styles, but jazz lead sheets occupy a special position among them.

...
The present thesis follows this template.
...
pipeline fo r chord-symbol recognition on printed and handwritten lead
...
sheets.
End-to-end deep models (CRNN--CTC for monophonic input in
\Cref{sec:soa-crnn}, transformers for polyphonic and full-page input in

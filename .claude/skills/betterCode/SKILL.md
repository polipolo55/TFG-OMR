...
name: betterCode
description: >
  Behavioral guidelines to reduce common LLM coding mistakes. Enforces thinking before coding,
  simplicity first, surgical changes, and goal-driven execution with verifiable success criteria.
  Trigger: /betterCode, "better code", "coding guidelines", "reduce mistakes", or when starting
  a non-trivial implementation task.
---

# Better Code

Guidelines to cut common LLM coding mistakes. Bias toward caution over speed — use judgment on trivial tasks.

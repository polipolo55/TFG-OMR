...
Music archives, educational institutions, and individual musicians hold enormous quantities 
of repertoire that exists only in paper or low-resolution scans. 
These collections cannot be searched, transposed, played back, 
or mathematically analysed without manual transcription into notation software. 
This manual process is slow, demands specialist training, 
and is repeatedly identified as a principal cost driver in corpus-level 
digitisation projects~\cite{calvoZaragozaUnderstandingOMR2020, hajicOMRMetricsEvaluation2019}.

The practical consequences are significant: educators struggle to assign jazz standards in new keys, 
musicologists cannot apply statistical methods to scanned PDFs, 
and musicians cannot feed a worn photocopy of \textit{The Real Book} into digital practice apps.

While OCR technology solved an equivalent problem for text decades ago, 
making printed documents editable at almost zero marginal cost, 
OMR remains far less mature. 
The visual language of music notation is substantially more complex than alphabetic text, 
available annotated data is drastically smaller, and the research community is correspondingly narrower.

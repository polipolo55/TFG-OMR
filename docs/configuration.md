...
| `rare_lmx_oversample` | 1 | Oversampling factor for samples containing rare tokens. **Disabled (1) by default** since the 2026-06-12 retrain — with 2× the tie category still showed 31 % test error (duplicating images doesn't teach tie disambiguation). Kept as a flag for ablations. |

...
Table~\ref{tab:results-headline} consolidates the headline numbers
...
(see Table~\ref{tab:results-headline}).
...
Table~\ref{tab:results-headline}: aggregate SER around \SI{1.2}{\percent}

...
so is too small to train such a model from scratch. Every recent end-to-end
...
this thesis and the concurrent work of
\textcite{martinezSevillaJazzLeadSheets2025} are the first two focused
efforts.
